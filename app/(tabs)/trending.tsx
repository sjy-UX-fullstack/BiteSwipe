          ...
          <GlassCard style={s.importer}>
            ...
            <TouchableOpacity activeOpacity={0.8}>
              <LinearGradient colors={['#56CCF2', '#2F80ED']} start={{x:0,y:0}} end={{x:1,y:0}} style={s.impBtn}>
                <Feather name="clipboard" size={16} color="#fff" style={{marginRight:8}}/>
                <Text style={s.impBtnText}>Paste Link</Text>
              </LinearGradient>
            </TouchableOpacity>
          </GlassCard>
...
const s = StyleSheet.create({
  ...
  impBtn:{flexDirection:'row',alignItems:'center',justifyContent:'center',paddingVertical:Spacing.sm,borderRadius:Radius.full},
